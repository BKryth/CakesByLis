...
import { SavetoLogs } from "../js/systemlogs.js"
	...
	// Update button click
        $(document).on("click", ".add", function(){
			...
			var selectinput3 = $(this).parents("tr").find('select[name="deliveryTime"]');
			...
			var selectinput4 = $(this).parents("tr").find('input[type="date"]');
            ...
            if(!empty){	
				...
				let deliveryTime = $(this).parents("tr").find("select[name=deliveryTime]").val();
				let deliveryDate = $(this).parents("tr").find("input[type=date]").val();
				...
				selectinput3.each(function(){
                    $(this).parent("td").html($(this).val());
                });
				
				selectinput4.each(function(){
                    $(this).parent("td").html($(this).val());
                });
				...
				SavetoLogs(name + " order was edited with this new time: " + deliveryTime);
				SavetoLogs(name + " order was edited with this new time: " + deliveryDate);
        ...
        $(document).on("click", ".edit", function(){		
			...
			$(this).parents("tr").find("td[id=deliveryTM]").each(function(){
                $(this).html('<select name="deliveryTime" id="DTimebox" class="form-control selectpicker form-control-select"><option value="'+ $(this).text() +'"> '+ $(this).text() +'</option><option value="8:00AM">8:00am</option><option value="9:00AM">9:00am</option><option value="10:00AM">10:00am</option><option value="11:00AM">11:00am</option><option value="12:00AM">12:00am</option><option value="1:00PM">1:00pm</option><option value="2:00PM">2:00pm</option><option value="3:00PM">3:00pm</option><option value="4:00PM">4:00pm</option><option value="5:00PM">5:00pm</option><option value="6:00PM">6:00pm</option><option value="7:00PM">7:00pm</option><option value="8:00PM">8:00pm</option><option value="9:00PM">9:00pm</option><option value="10:00PM">10:00pm</option><option value="11:00PM">11:00pm</option><option value="12:00AM">12:00am</option></select> ');
            });	
			$(this).parents("tr").find("td[id=deliveryDT]").each(function(){
                $(this).html('<input type="date" class="form-control form-control-inline" placeholder="Enter Your Delivery Date" id="DDatebox"  value="'+ $(this).text() +'"> ');
            });	
